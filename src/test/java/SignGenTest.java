...
public class SignGenTest {
    ...
    public static void main(String[] args) {
        try {
            //永久KeyId示例
            genSign("yichun", "yichun", "GET", "text/xml", null, null, null);

            //临时KeyId示例
//            genSign("DSS.6n4hMiHkcNyG0ZUikDhJ", "Qrn2GDB5dPcMHBJPe7w0wFOZD5h3ZmfZ7InewqyY", "GET", "text/xml", null, null,
//                    "rC6X0asnazGeOqpy2krt8BJADTxwqlOMM9fhR91B3Jwlqjx72I7HX9kx9NZDmu1uO2TKmaZS58jz4FXZDzhSGGWgnEfuoFQApqDNMOdBQDxz24116rEK0PRa7lw4lDKy");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
     ...
     * @return String      返回DSS-Authorization的值
